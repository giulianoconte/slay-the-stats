...
- [BaseLib](https://www.nexusmods.com/slaythespire2/mods/103) v3.3.0 or later.
- **NOTE:** GUMM is NOT required. If you previously installed it for this mod, see [Uninstalling GUMM](#uninstalling-gumm) below.

### Installation

1. Download and extract [BaseLib](https://www.nexusmods.com/slaythespire2/mods/103) (v3.3.0 or later) into your mods folder if you haven't already
